...
from structgenie.input_output._example_parser import type_schema_from_examples
from structgenie.input_output._extract_notation import io_lines_from_string
from structgenie.input_output._pydantic_parser import extract_model
from structgenie.input_output.base import IOModel
...
class InputModel(IOModel):
    ...
    @classmethod
    def from_examples(cls, examples: list[Example], **kwargs):
